...
INSERT INTO ofertas (malla_materia_id, semestre, paralelo, horario_json, docente, aula)
SELECT s.malla_materia_id, s.semestre, s.paralelo, s.horario_json, s.docente, s.aula
FROM tmp_seed_ofertas s
WHERE NOT EXISTS (
    SELECT 1
    FROM ofertas o
